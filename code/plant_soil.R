...
df_t_m_f_na <- na.omit(df_t_m)
# plot soil_tem points and lines over time group by myco ----
ggplot(df_t_m_f_na, aes(x = time, y = soil_tem, 
                   color = myco, group = myco)) +
  geom_point() + 
  geom_line() +  # This ensures both groups are plotted correctly
